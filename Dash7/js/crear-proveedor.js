...
function saveSupplier(supplierData) {
  ...
  currentSupplierId++;
  localStorage.setItem('lastSupplierId', currentSupplierId.toString());
  
  console.log('✅ Proveedor guardado:', supplierData);
}
...
function showSuccessScreen(supplierData) {
  // Ocultar formulario
  document.querySelector('.supplier-form').style.display = 'none';
